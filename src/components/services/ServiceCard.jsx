...
import { MdCheckCircle, MdHelp, MdLightbulb } from 'react-icons/md'
    ...
    return (
      ...
      >
        <div className={index % 2 === 1 ? 'lg:order-2' : ''}>
          ...
          {/* Problem - Avec icône React */}
          <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-4 rounded-r-xl flex items-start space-x-3">
            <MdHelp className="text-red-500 flex-shrink-0 mt-0.5" size={22} />
            <p className="text-red-700 font-medium">{service.problem}</p>
          </div>
          
          {/* Solution - Avec icône React */}
          <div className="bg-primary-50 border-l-4 border-primary-500 p-4 mb-6 rounded-r-xl flex items-start space-x-3">
            <MdLightbulb className="text-primary-500 flex-shrink-0 mt-0.5" size={22} />
